    ...
    <div className="flex flex-col items-center justify-center space-y-5 divide-y-2 text-lg font-semibold text-[#55564E] md:text-xl lg:text-2xl">
      {types.map((type) => (
        ...
        >
          ...
          <div className="mx-auto flex w-screen items-center justify-center overflow-x-hidden md:hidden">
            <Carousel
              // showStatus={false}
              ...
              {allProducts !== undefined &&
                ...
                allProducts
                  ...
                  .map((product: any) => (
                    <div
                      key={product._id}
                      className="mx-auto flex flex-col overflow-x-hidden px-3 py-2"
                    >
                      <div className="relative mx-auto flex w-fit items-center justify-center  ">
                        <img
                          src={`${backend_url}${product.image}`}
