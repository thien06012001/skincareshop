...
import { updateCustomerInformation } from "@/redux/actions/user";
...
function Profile({}: Props) {
  ...
  const handleSubmit = (e: any) => {
    e.preventDefault();
    dispatch(updateCustomerInformation(email, phoneNumber, password, address));
  ...
  return (
    <div className="m-auto w-full bg-[#F0E4DB] px-4 py-3 text-[#2C2C2C]">
      ...
      <form
        ...
        className="relative flex flex-col w-full space-y-3 px-4 py-2"
      >
